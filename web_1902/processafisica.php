...
grupo_id ) 
VALUES 
('$nome','a','a','a','a','a','a','a', 1,now(),'Ativo', $idlogin, $coleta_tb_grupo)";
...
$sqlinsert4 = "INSERT INTO coleta_tb_telefone (telefone_celular, telefone_fixo, telefone_comercial, telefone_empresarial, usuario_id) VALUES ('$telefonecelular', ' ', ' ',  ,$idlogin)";
$exibe_tele = mysqli_query($conn, $sqlinsert4);

if(mysqli_insert_id($conn)){
        $_SESSION['msg'] = "<div class = 'alert alert-success'>Cadastro efetuado com sucesso!</div>";
    header("Location: CadastropessoaFisica.php");
    }else{
